<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile_Monitor.master" AutoEventWireup="true" CodeFile="Mobile_Monitor_Defeitos_Dados_Ping_Pong.aspx.cs" Inherits="Mobile" %>
    ...
    <div class="row center-align" style="margin: 0px; padding: 0px; border: 0px">
         <div class="col s12" style="margin: 0px; padding-left: 1%; border: 0px">
             <asp:GridView
                ...
                GridLines="Vertical"
                CssClass="mGrid"
                Width="100%" OnRowDataBound="GridView_Defeitos_Abertos_RowDataBound" OnSelectedIndexChanged="GridView_Defeitos_Abertos_SelectedIndexChanged" DataKeyNames="Id">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Ping_Pong" HeaderText="Ping Pong" ItemStyle-CssClass="td-center">
                         <ItemStyle VerticalAlign="Middle" />
                    </asp:BoundField>

                    <asp:BoundField DataField="Risco_Projeto" HeaderText="Risco" ShowHeader="False">
                         <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" CssClass="td-center" />
                    </asp:BoundField>

                    <asp:TemplateField HeaderText="CTs Impac." ItemStyle-CssClass="td-center">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("Qtd_CTs_Impactados") %>'></asp:Label>
                            <tr>
                                <td colspan="100%">
