<script>
  ...
  import oiReport from '@/module/project/test/comp/showReport.vue'
  ...
  import oiView from '@/module/project/test/comp/view.vue'
  import services from '../services'
  import services2 from '@/module/project/test/services'
