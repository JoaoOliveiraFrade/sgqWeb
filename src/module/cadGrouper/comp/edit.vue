...
<template>
  <div id="cadProjectsEdit" v-if="item != undefined">
    <div id="cabecalho" class="row well-sm oi-well">
      ...
      <div class="col-xs-12 oi-col">
        <label class="fd-label">Tipo:&nbsp;&nbsp;</label>
        
        <input type="radio" id="STATUS" value="STATUS" v-model="item.grouper.type">
        <label class="fd-label" for="STATUS">Status</label>

        <input type="radio" id="CONSULTA" value="CONSULTA" v-model="item.grouper.type">
        <label class="fd-label" for="CONSULTA">Consulta</label>    
      </div> 
    ...
    <div id="abas" class="row well well-sm oi-well" >
      <div class="row well-sm oi-well">
          ...
          <div class="tab-content">
            <div id="executiveSummary" class="tab-pane fade in" v-show="item.grouper.type === 'STATUS'" style="padding:0; margin:0; text-align: center">
              <div class="col-xs-12 oi-col">
