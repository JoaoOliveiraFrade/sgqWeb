<script>
  ...
  export default {
    name: 'indicatorPerfDefectDensity',

    components: { oiDevManufSelection, oiSystemSelectionFbyDevManufs, oiProjectSelectionFbyDevManufsAndSystems, oiShowData },

    computed: {
      ...mapState('indicatorPerfDefectDensity', ['selectedDevManufs', 'selectedSystems', 'selectedProjects']),
      ...mapGetters('indicatorPerfDefectDensity', ['showData'])
    },

    methods: {
      ...mapActions(['setFeatureName']),
      ...mapActions('indicatorPerfDefectDensity', ['setSelectedDevManufs', 'setSelectedSystems', 'setSelectedProjects'])
    },
