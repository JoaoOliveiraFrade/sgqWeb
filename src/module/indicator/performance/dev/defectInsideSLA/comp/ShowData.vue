<script>
  ...
  // import oiDefectDensityRule from '@/module/indicator/performance/dev/defectInsideSLA/defectDensity/comp/ShowRule.vue'
  ...
  export default {
    ...
    methods: {
      ...mapActions('indPerfDevDefectInsideSLA', ['load'])
    },
