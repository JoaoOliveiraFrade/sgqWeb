<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters('indPerfDevDefectOfTSInTIAgent', ['total']),
      ...mapState('indPerfDevDefectOfTSInTIAgent', ['acceptableLimit', 'limitModeratePerc', 'limitHigh']),
      ...
      chartParam () {
        ...
        param.tooltip.pointFormat = '' +
          ...
          'Qte Total Defeito: ' + this.total.qtyDefect
