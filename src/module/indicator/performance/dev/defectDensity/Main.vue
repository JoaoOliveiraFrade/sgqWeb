<script>
  ...
  export default {
    ...
    computed: {
      ...mapState('indPerfDevDefectDensity', ['selectedDevManufs', 'selectedSystems', 'selectedProjects'])
      // ...mapGetters('indPerfDevDefectDensity', ['showData'])
    },

    methods: {
      ...mapActions(['setFeatureName']),
      ...mapActions('indPerfDevDefectDensity', ['setSelectedDevManufs', 'setSelectedSystems', 'setSelectedProjects'])
    },
