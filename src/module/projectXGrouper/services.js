...
export default {
  ...
  getByProjectId (id) {
    let resource = Resource.resource(paths.apiDefault + '/ProjectXGrouper/ByProject/{id}')
    return resource.get()
  },

  getByProject (subproject, delivery) {
    let resource = Resource.resource(paths.apiDefault + '/ProjectXGrouper/ByProject/{subproject}/{delivery}')
    return resource.get()
  },

  getByGrouper (id) {
    let resource = Resource.resource(paths.apiDefault + '/ProjectXGrouper/ByGrouper/{id}')
