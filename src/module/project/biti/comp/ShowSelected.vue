  ...
  <span v-show="Object.keys(selected).length > 0">
    ...
    <div class="col-xs-12	col-sm-6 col-md-6	col-lg-3">
      <div>
        ...
        <label class="fd-content">{{selected.GP}}</label>
      </div>
    </div>
    ...
    <div class="col-xs-12	col-sm-6 col-md-6	col-lg-3">
      <div>
        ...
        <label class="fd-content">{{selected.N3}}</label>
      </div>
    </div>
    ...
    <div class="col-xs-12">
      <div>
        ...
        <label class="fd-content">{{selected.objective}}</label>
      </div>
    </div>
