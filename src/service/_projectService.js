...
export default {
  ...
  getByTestManufsAndSystems (testManufs, systems) {
    let resource = Resource.resource(paths.api + '/project/testProj/ByTestManufsAndSystems')
    return resource.save({ testManufs: testManufs, systems: systems })
  },
