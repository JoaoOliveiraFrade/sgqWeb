<script>
import ModesTable from './ModesTable.vue'
import DemoErrorModal from './DemoErrorModal.vue'
import DemoFocusModal from './InputFocusModal.vue'
import DemoLoginModal from './DemoLoginModal.vue'
import DemoDogProfileModal from './DogProfileModal.vue'
import DemoConditionalModal from './ConditionalModal.vue'
import DemoSizeModal from './SizeModal.vue'
