<script>
  ...
  import oiBrand from '@/genComp/header/BrandHeader.vue'
  import oiButtonMobile from '@/genComp/header/ButtonMobileHeader.vue'
  import oiMenu from '@/genComp/header/MenuHeader.vue'
